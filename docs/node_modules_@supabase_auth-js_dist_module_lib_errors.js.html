...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/@supabase/auth-js/dist/module/lib/errors.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/@supabase/auth-js/dist/module/lib/errors.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>export class AuthError extends Error {
